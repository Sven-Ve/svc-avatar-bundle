...
class SvcAvatarBundle extends AbstractBundle
{
    public function configure(DefinitionConfigurator $definition): void
    {
        $definition->rootNode()
          ->children()
            ->stringNode('fontcolor')->info('Hex color for the font, without the hash (#)')->end()
            ->stringNode('backgroundcolor')->defaultValue('random')->info('Hex color for the image background, without the hash (#). Default: random')->end()
